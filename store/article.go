...
// NewOriginStore make DB model for
func NewOriginStore(db *gorm.DB) *OriginStore {
	return &OriginStore{
		db: db,
	}
}

// Create a Origin in DB
func (us *OriginStore) Create(u *model.Origin) (err error) {
	return us.db.Create(u).Error
}

// Update a Origin in DB
func (us *OriginStore) Update(u *model.Origin) error {
